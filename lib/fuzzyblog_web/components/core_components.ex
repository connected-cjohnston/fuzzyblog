defmodule FuzzyblogWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FuzzyblogWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FuzzyblogWeb.Gettext, "errors", msg, opts)
    end
  end
